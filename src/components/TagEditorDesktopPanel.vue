<template>
  <section class="tag-editor-panel" style="padding:16px;">
    ...
    <div class="tag-create-panel desktop">
      <div class="tag-create-row">
        ...
        />
        <select v-model="tagNewParentIdModel" class="text-input tag-parent-select">
...
interface TagEditorDesktopPanelProps {
...
const props = defineProps<TagEditorDesktopPanelProps>();
